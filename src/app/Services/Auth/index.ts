...
import { TIncompleteUser } from "../../../types/UserType";
...
class Auth {
    ...
    public static async attempt(username: string, password: string): Promise<User | null> {
    ...
    public static async updateOnlineStatus(isOnline: boolean = true): Promise<User | null> {
        if (!this._user) {
            return null;
        }
    ...
    public static async createAndLogin(userData: TIncompleteUser) {
