...
import { CommentType, IncompleteCommentType } from "../../../types/CommentType";
...
class Comment {
    ...
    public set user(value: UserType | User) {
    ...
    public static make(comment: CommentType | null): Comment | null {
        return comment ? new Comment(comment) : null;
    }

    public static async create(
        commentData: IncompleteCommentType
