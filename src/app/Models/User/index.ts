...
import { TIncompleteUser, TUser } from "../../../types/UserType";
...
class User {
    ...
    public static make(user: TUser | null): User | null {
        return user ? new User(user) : null;
    }

    public static async create(userData: TIncompleteUser): Promise<User | null> {
        return this.make(
